...
const fetchFaculties = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${facultyServiceUrl}/`);
        return Array.isArray(response.data) ? response.data : [];
    } catch (error) {
...
const addFaculty = async (facultyData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${facultyServiceUrl}/create`, facultyData);
...
const editFaculty = async (facultyId, facultyData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${facultyServiceUrl}/update/${facultyId}`, facultyData);
        return {
            success: true,
...
const deleteFaculty = async (facultyId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`${facultyServiceUrl}/delete/${facultyId}`);
        return {
            success: true,
...
//# sourceMappingURL=Components_3c1e1112._.js.map