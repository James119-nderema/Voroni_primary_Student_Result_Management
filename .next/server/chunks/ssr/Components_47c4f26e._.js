...
const LecturerScheduleService = {
    ...
    regenerateAllLecturerSchedules: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${lecturerScheduleUrl}/availabilities/generate`, {}, {
                headers
            });
...
"[project]/Components/Services/RoomFacultyService.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
const roomFacultyUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/rooms`;
const fetchSelectedRoomFaculties = async (facultyId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${roomFacultyUrl}/faculty/selected/${facultyId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const fetchAvailableRoomFaculties = async (facultyId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${roomFacultyUrl}/faculty/available/${facultyId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const addRoomToFaculty = async (facultyId, roomId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${roomFacultyUrl}/faculty/create`, {
            facultyId,
            roomId
        }, {
            headers
...
const removeRoomFromFaculty = async (facultyId, roomId)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`${roomFacultyUrl}/faculty/delete`, {
            headers: {
                ...headers,
                'Content-Type': 'application/json'
            },
...
const createAllCombinations = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${roomFacultyUrl}/faculty/create/all`, {}, {
            headers
        });
        return response.data;
    } catch (error) {
...
const fetchAvailableRoomSchedules = async (facultyId)=>{
    ...
    const [rooms, days, timeslots] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$rooms$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getAllRooms(),
        fetchDays(),
        fetchTimeslots()
    ]);
...
"[project]/Components/Services/LecturerCoursesService.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const lecturerCoursesUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/courses`;
const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
const fetchAvailableCourses = async (lecturerId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${lecturerCoursesUrl}/lecturers/available/${lecturerId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const fetchSelectedCourses = async (lecturerId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${lecturerCoursesUrl}/lecturers/selected/${lecturerId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const addLecturerCourse = async (lecturerId, courseId)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/create`, lecturerCourse, {
            headers
        });
        return {
            success: true,
...
const removeLecturerCourse = async (lecturerId, courseId)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/remove`, lecturerCourse, {
            headers
        });
        return {
            success: true,
...
const generateLecturerCourses = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/generate/all`, {}, {
            headers
        });
        return {
            success: true,
...
//# sourceMappingURL=Components_47c4f26e._.js.map