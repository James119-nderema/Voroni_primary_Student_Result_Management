...
const AddClasess = ()=>{
    ...
    const handleSubmit = (e)=>{
        ...
        if (!formData.class_size || parseInt(formData.class_size) <= 0) {
            setError('Class_detail capacity must be greater than 0');
            setLoading(false);
            return;
        }
        if (!formData.year_id || parseInt(formData.year_id) <= 0) {
            setError('Year must be greater than 0');
            setLoading(false);
            return;
        }
        if (!formData.semester_id || parseInt(formData.semester_id) <= 0) {
            setError('Semester must be greater than 0');
            setLoading(false);
            return;
        }
        const xhr = new XMLHttpRequest();
        xhr.open('POST', 'http://localhost:9921/class', true);
        ...
        xhr.onreadystatechange = ()=>{
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    setError('Failed to add class_detail');
                }
            }
        };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: loading ? 'Adding...' : 'Add Class'
                        }, void 0, false, {
                            fileName: "[project]/Components/ClassesPage/AddClasses.jsx",
                            lineNumber: 88,
                            columnNumber: 11
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__13df10._.js.map