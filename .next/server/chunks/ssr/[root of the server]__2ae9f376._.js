...
const registerUser = async (username, password, firstName, lastName)=>{
    ...
    return response.json(); // Return the database response directly
};
}}),
...
const Login = ()=>{
    ...
    // Reset form fields when toggling between login and register
    const toggleMode = ()=>{
        setIsLogin(!isLogin);
        setUsername('');
        setPassword('');
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Check if response is a successful profile object (should have some expected properties)
            // This assumes your profile has an id or username property
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2ae9f376._.js.map