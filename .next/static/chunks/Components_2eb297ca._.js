(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/Components_2eb297ca._.js", {
...
;
;
const header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
;
...
;
;
const header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])(); // Add authorization headers
const timetableServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}`;
const TimetableService = {
    getTimetable: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${timetableServiceUrl}/timetable/`, {
                headers: header
            });
    ...
    generateTimetable: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${timetableServiceUrl}/timetable/generate`, {
                headers: header
            });
            return response.data;
        } catch (error) {
    ...
    getLecturers: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${timetableServiceUrl}/lecturers/`, {
                headers: header
            });
            return response.data;
        } catch (error) {
    ...
    getClasses: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${timetableServiceUrl}/classes/all`, {
                headers: header
            });
            return response.data;
        } catch (error) {
    ...
    getRooms: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${timetableServiceUrl}/rooms/`, {
                headers: header
            });
            return response.data;
        } catch (error) {
...
"[project]/Components/Services/rooms.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
;
const roomServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/rooms`;
const roomsService = {
    getAllRooms: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${roomServiceUrl}/`);
    ...
    deleteRoom: async (roomId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${roomServiceUrl}/${roomId}`);
            return response.data;
        } catch (error) {
    ...
    createRoom: async (roomData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${roomServiceUrl}/create`, roomData);
            return response.data;
        } catch (error) {
    ...
    updateRoom: async (roomId, roomData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${roomServiceUrl}/${roomId}`, roomData);
            return response.data;
        } catch (error) {
    ...
    getRoomById: async (roomId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${roomServiceUrl}/rooms/${roomId}`);
            return response.data;
        } catch (error) {
...
"[project]/Components/Services/periodService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
;
const periodServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/periods`;
const getPeriods = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${periodServiceUrl}`, header);
...
const deletePeriod = async (periodId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${periodServiceUrl}/${periodId}`, header);
        return response.data;
    } catch (error) {
...
const createPeriod = async (periodData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${periodServiceUrl}/create`, periodData, header);
        return response.data;
    } catch (error) {
...
const updatePeriod = async (periodId, periodData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${periodServiceUrl}/${periodId}`, periodData, header);
        return response.data;
    } catch (error) {
...
const getPeriodById = async (periodId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${periodServiceUrl}/${periodId}`, header);
        return response.data;
    } catch (error) {
...
;
;
const programServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/programs`;
const ProgramService = {
    // Fetch all programs
    getPrograms: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${programServiceUrl}/`);
    ...
    createProgram: async (programData)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${programServiceUrl}/create`, programData);
    ...
    deleteProgram: async (programId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${programServiceUrl}/delete/${programId}`);
            return response.data;
        } catch (error) {
    ...
    getPeriods: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${programServiceUrl}/periods`);
    ...
    getCourses: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${programServiceUrl}/courses`);
    ...
    getProgramCourses: async (programId, periodId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${programServiceUrl}/programCourses/${programId}/${periodId}`);
            return response.data;
        } catch (error) {
    ...
    addProgramCourse: async (programId, periodId, courseId)=>{
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${programServiceUrl}/programCourse`, {
                programId,
                periodId,
                courseId
            });
    ...
    deleteProgramCourse: async (programCourseId)=>{
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${programServiceUrl}/programCourse/${programCourseId}`);
        } catch (error) {
    ...
    updateProgram: async (programData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${programServiceUrl}/update/${programData.programId}`, programData, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
...
"[project]/Components/Services/courses.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const courseServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/courses`;
const fetchCourses = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${courseServiceUrl}/`);
...
const addCourse = async (courseData)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${courseServiceUrl}/create`, courseData);
...
const editCourse = async (courseId, courseData)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${courseServiceUrl}/update/${courseId}`, courseData);
...
const deleteCourse = async (courseId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${courseServiceUrl}/delete/${courseId}`);
        return {
            success: true,
...
const getCourseById = async (courseId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${courseServiceUrl}/${courseId}`);
        return response.data;
    } catch (error) {
...
"[project]/Components/Services/facultyService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const facultyServiceUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/faculties`;
const fetchFaculties = async ()=>{
    try {
        const authHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${facultyServiceUrl}/`, authHeader);
        return Array.isArray(response.data) ? response.data : [];
    } catch (error) {
...
const addFaculty = async (facultyData)=>{
    try {
        const authHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${facultyServiceUrl}/create`, facultyData, authHeader);
...
const editFaculty = async (facultyId, facultyData)=>{
    try {
        const authHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${facultyServiceUrl}/update/${facultyId}`, facultyData, authHeader);
        return {
            success: true,
...
const deleteFaculty = async (facultyId)=>{
    try {
        const authHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${facultyServiceUrl}/delete/${facultyId}`, authHeader);
        return {
            success: true,
...
"[project]/Components/Services/RoomFacultyService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const removeRoomFromFaculty = async (facultyId, roomId)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${roomFacultyUrl}/faculty/delete`, {
            headers: {
                ...headers,
                'Content-Type': 'application/json'
            },
...
const fetchAvailableRoomSchedules = async (facultyId)=>{
    const response = await fetch(`${roomScheduleUrl}/schedule/available/${facultyId}`, {
        headers
    });
    if (!response.ok) {
    ...
    const [rooms, days, timeslots] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$rooms$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getAllRooms(),
        fetchDays(),
        fetchTimeslots()
    ]);
...
const fetchSelectedRoomSchedules = async (facultyId)=>{
    const response = await fetch(`${roomScheduleUrl}/schedule/selected/${facultyId}`, {
        headers
    });
    if (!response.ok) {
...
const regenerateSchedules = async (facultyId)=>{
    if (!facultyId) {
...
"[project]/Components/Services/scheduletrackerservice.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/Components/Services/LecturerCoursesService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "addLecturerCourse": (()=>addLecturerCourse),
    "fetchAvailableCourses": (()=>fetchAvailableCourses),
    "fetchSelectedCourses": (()=>fetchSelectedCourses),
    "generateLecturerCourses": (()=>generateLecturerCourses),
...
;
;
const lecturerCoursesUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$HostConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/courses`;
const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$LoginService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAuthHeaders"])();
const fetchAvailableCourses = async (lecturerId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${lecturerCoursesUrl}/lecturers/available/${lecturerId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const fetchSelectedCourses = async (lecturerId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${lecturerCoursesUrl}/lecturers/selected/${lecturerId}`, {
            headers
        });
        return response.data;
    } catch (error) {
...
const addLecturerCourse = async (lecturerId, courseId)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/create`, lecturerCourse, {
            headers
        });
        return {
            success: true,
...
const removeLecturerCourse = async (lecturerId, courseId)=>{
    try {
        const lecturerCourse = {
            lecturerId: lecturerId,
            courseId: courseId,
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/remove`, lecturerCourse, {
            headers
        });
        return {
            success: true,
...
const generateLecturerCourses = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${lecturerCoursesUrl}/lecturers/generate/all`, {}, {
            headers
        });
        return {
            success: true,
            message: response.data.message || "Lecturer courses generated successfully!"
        };
    } catch (error) {
        return {
            success: false,
            message: error.response?.data?.message || "Failed to generate lecturer courses"
        };
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/Components/Common/ConfirmationDialog.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=Components_2eb297ca._.js.map