(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/Components_50a1fc13._.js", {
...
"[project]/Components/Services/dashboardService.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
const fetchFaculties = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${facultyServiceUrl}/`);
        return Array.isArray(response.data) ? response.data : [];
    } catch (error) {
...
const addFaculty = async (facultyData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${facultyServiceUrl}/create`, facultyData);
        // Check if we have a response with status in the 200 range
...
const editFaculty = async (facultyId, facultyData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${facultyServiceUrl}/update/${facultyId}`, facultyData);
        return {
            success: true,
...
const deleteFaculty = async (facultyId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${facultyServiceUrl}/delete/${facultyId}`);
        return {
            success: true,
...
//# sourceMappingURL=Components_50a1fc13._.js.map