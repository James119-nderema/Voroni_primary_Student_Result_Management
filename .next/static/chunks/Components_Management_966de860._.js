...
const AddFacultyPopup = ({ onClose, onFacultyAdded })=>{
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [success, setSuccess] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // Keep for inline message if desired
    const handleChange = (e)=>{
        const { name, value } = e.target;
        setFacultyData((prev)=>({
                ...prev,
...
const FacultiesPage = ()=>{
    ...
    const handleDeleteFaculty = async (facultyId)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Services$2f$facultyService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteFaculty"])(facultyId);
            if (result.success) {
...
_s(FacultiesPage, "TKU5H1HzpqVNhT4VdxxOX++pDzE=");
_c = FacultiesPage;
