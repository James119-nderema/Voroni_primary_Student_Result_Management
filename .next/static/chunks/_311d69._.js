(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_311d69._.js", {
...
"[project]/utils/Services/api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const fetchTodaysSchedules = async ()=>{
    try {
        const response = await fetch("http://localhost:9921/timetable/today");
        if (!response.ok) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/Services/api.js [app-client] (ecmascript)");
;
        ...
        "DashboardPage.useEffect": ()=>{
            const getSchedules = {
                "DashboardPage.useEffect.getSchedules": async ()=>{
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$Services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTodaysSchedules"])();
                    setSchedules(data);
                }
...
//# sourceMappingURL=_311d69._.js.map