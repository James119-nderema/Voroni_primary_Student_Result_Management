(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_react-router_dist_development_chunk-XJI4KG32_mjs_704e3e43._.js", {

"[project]/node_modules/react-router/dist/development/chunk-XJI4KG32.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/react-router/dist/development/chunk-XJI4KG32.mjs")}`;
    }
};
var __typeError = (msg)=>{
    throw TypeError(msg);
...
async function loadLazyRouteModule(route, mapRouteProperties2, manifest) {
    ...
    let lazyRoutePromise = route.lazy().then((lazyRoute)=>{
        ...
        for(let lazyRouteProperty in lazyRoute){
            ...
            if (!isPropertyStaticallyDefined && !unsupportedLazyRouteFunctionKeys.has(lazyRouteProperty)) {
...
async function loadLazyMiddleware(route, manifest) {
    ...
    if (routeToUpdate.unstable_middleware) {
        warning(false, `Route "${routeToUpdate.id}" has a static property "unstable_middleware" defined. The "unstable_lazyMiddleware" function will be ignored.`);
    } else {
...
//# sourceMappingURL=node_modules_react-router_dist_development_chunk-XJI4KG32_mjs_704e3e43._.js.map