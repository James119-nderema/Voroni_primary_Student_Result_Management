  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen p-2 sm:p-6 relative">
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-3 sm:p-6">
        ...
        <div className="mb-6">
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 w-48">
            <div>
              <h2 className="text-sm font-semibold text-blue-800 dark:text-blue-200">
                {filterClass ? `Students in ${filterClass}` : 'Total Students'}
              </h2>
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-300">
                {filterClass ? filteredStudents.length : allStudents.length}
              </p>
            </div>
          </div>
        </div>
