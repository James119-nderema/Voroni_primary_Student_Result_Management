...
const EditFaculty = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://localhost:9921/faculty/${facultyId}`, facultyData);
      setSuccess(true);
      setTimeout(() => {
        router.back();
      }, 2000);
    ...
    <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
      <div className="max-w-2xl w-full bg-white shadow-md rounded-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Edit Faculty</h1>
            <p className="mt-1 text-sm text-gray-500" aria-label="Edit faculty details">
              Update the details for the faculty
            </p>
          </div>
          <button
            onClick={() => router.back()}
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 rounded-md p-4 mb-6 animate-fadeIn">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-green-800">Faculty updated successfully! Redirecting...</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                <input
                  ...
                  className={`block w-full rounded-md py-2 px-3 border ${error && !facultyData.facultyName.trim()
              ...
              {error && !facultyData.facultyName.trim() && (
