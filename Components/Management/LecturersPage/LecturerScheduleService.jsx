...
export const LecturerScheduleService = {
  ...
  getLecturerCourses: async (lecturerId) => {
    try {
      const response = await axios.get(`${API_BASE_URL}/courses/${lecturerId}`);
      return response.data;
    } catch (error) {
  ...
  getLecturerSchedules: async (lecturerId) => {
    try {
      const response = await axios.get(`${API_BASE_URL}/schedules/${lecturerId}`);
      return response.data;
    } catch (error) {
  ...
  getLecturerAvailability: async (lecturerId) => {
    try {
      const response = await axios.get(`${API_BASE_URL}/availabilities/${lecturerId}`);
      return response.data;
    } catch (error) {
  ...
  regenerateLecturerSchedule: async (lecturerId) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/availabilities/generate/${lecturerId}`);
      return response.data;
    } catch (error) {
