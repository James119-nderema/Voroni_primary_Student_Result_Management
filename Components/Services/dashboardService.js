...
export const fetchTodaysSchedules = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/timetable/today`, { headers });
...
export const fetchTotalClasses = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/classes/total`, { headers });
    return response.data;
  } catch (error) {
...
export const fetchActiveLecturers = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/lecturers/active`, { headers });
    return response.data;
  } catch (error) {
...
export const fetchTotalRooms = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/rooms/total`, { headers });
    return response.data;
  } catch (error) {
...
export const fetchTotalTimetables = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/timetable/total`, { headers });
    return response.data;
  } catch (error) {
...
export const fetchDaySummary = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/timetable/summary`, { headers });
    return response.data;
  } catch (error) {
...
export const fetchResourceUtilization = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/rooms/utilization`, { headers });
