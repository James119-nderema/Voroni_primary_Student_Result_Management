...
export default function VoroniPrimarySchoolWebsite() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* WhatsApp Fixed Icon - Now using the actual WhatsApp logo */}
      <a 
      ...
      {/* Hero Section */}
      <section className="relative bg-blue-800 text-white py-16">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <img src="/api/placeholder/600/400" alt="Voroni Primary School" className="rounded-lg shadow-md" />
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://wa.me/254704548982" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300">
                  {/* Updated WhatsApp icon in footer */}
                  <img 
