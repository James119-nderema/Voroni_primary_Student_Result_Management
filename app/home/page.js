...
export default function VoroniPrimarySchoolWebsite() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50" style={{ scrollbarWidth: 'none' }}>
      ...
      <section className="py-16 bg-white w-full px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <img src="images/Image4.jpg" alt="Voroni Primary School" className="rounded-lg shadow-md w-full" />
          </div>
